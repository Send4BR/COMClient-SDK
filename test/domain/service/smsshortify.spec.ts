...
tap.test('Should shortify message and insert see more', (t) => {
  ...
  t.equal(message, 'Loja Aftersale: Seu pedido está em transferência e em breve estará a caminho de uma cidade m ... Veja mais em: https://go.after.sale/abcdefg PEDIDO 123456789-01')
  t.end()
})
